...
```bash
user-management-api$ sam build --use-container
```
...
```bash
user-management-api$ sam logs -n HelloWorldFunction --stack-name "user-management-api" --tail
```
...
```bash
user-management-api$ pip install -r tests/requirements.txt --user
# unit test
user-management-api$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
user-management-api$ AWS_SAM_STACK_NAME="user-management-api" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "user-management-api"
```
